...
public class BookServiceImpl implements BookService {
    ...
    @Override
    public Book findBookById(Integer id) throws ExecutionException, InterruptedException {
    ...
    @Override
    public void insertBook(Book book) throws ExecutionException, InterruptedException {
    ...
    @Override
    public void deleteBook(Integer id) throws ExecutionException, InterruptedException {
